...
from beantheory.knowledge.knowl import Knowl, knowldb, knowl_title, knowl_exists, knowl_url_prefix
from beantheory.users import admin_required, knowl_reviewer_required
from beantheory.users.pwdmanager import userdb
from lmfdb.utils import to_dict, code_snippet_knowl
import markdown
from beantheory.knowledge import logger
...
from beantheory.knowledge import knowledge_page
...
@app.route("/content/<ID>/<int:timestamp>")
...
@app.route("/raw/<ID>/<int:timestamp>")
def raw(ID):
...
@app.route("/comment_history/<int:limit>")
@login_required
...
@app.route("/review/<ID>/<int:timestamp>")
...
@app.route("/demote/<ID>/<int:timestamp>")
@knowl_reviewer_required
...
@app.route("/review_recent/<int:days>/")
@knowl_reviewer_required
